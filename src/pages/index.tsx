...
const highlightCta: HighlightsCta = {
  ...
  description: 'In order to become a Christian, you have to have faith in God, repent your sins, and confess/confess all of your sins to God. The Bible says "For with the heart a person believes and thus is justified, and with the mouth he confesses and thus is saved" (Romans 10:10).',
};

const findCellDescription = "We believe the Bible is God's word, intended to be read, studied and believed. We are a cell based Church means we meet in small groups consisting of about 8-12 people who live near each other. Our only motive is to glorify God and serve Him by serving His people, our members. Each group that gathers together studies what God has said in the Bible and how it applies to their daily lives.";
    ...
    <Layout>
      ...
      <Container className="my-8 grid grid-cols-1 lg:grid-cols-2 ul:grid-cols-3 lg:gap-x-12 ul:grid-rows-3">
        ...
        <div className="lg:col-span-2 col-start-1">
          <h2 className="flex items-center my-2 font-bold gap-x-2 text-primary">{highlightCta.title} &#8594;</h2>
          <p>{highlightCta.description}</p>
        </div>
        <figure className="hidden w-full my-2 ul:block row-span-3 row-start-1 col-start-3">
          <img src="https://picsum.photos/id/1005/400/250" className="object-cover h-full rounded-lg" alt="Church Building" />
        </figure>
      </Container>
      <Container className="p-2 bg-base-100">
        ...
        <MiniContainer className="mb-12 grid grid-cols-2 lg:grid-cols-3 gap-x-20">
          <img src="https://picsum.photos/id/1005/400/250" alt="Find Cell Near You" className="hidden object-cover h-full rounded-lg row-span-3 lg:block" />
          ...
          <button className="btn"><Trans>Join Cell</Trans></button>
        </MiniContainer>
      </Container>
      <Container>
        ...
        <div className="px-12 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 xxl:gap-32">
          {newsThumbs.map(news => <NewsThumbnail key={news.title} {...news} />)}
        </div>
      </Container>
    </Layout>
  );
    ...
    <div className="rounded-lg shadow-xl card image-full no-bg">
      ...
      <div className="justify-end card-body">
        ...
        <div className="card-actions">
          <svg xmlns="http://www.w3.org/2000/svg" className="w-4 h-4" viewBox="0 0 28.102 30.891">
            <g data-name="Icon feather-calendar" fill="none" stroke="#fff" stroke-linecap="round" stroke-linejoin="round" stroke-width="3">
              <path data-name="Path 25" d="M4.289 4.289h19.524A2.789 2.789 0 0 1 26.6 7.078v19.524a2.789 2.789 0 0 1-2.787 2.787H4.289A2.789 2.789 0 0 1 1.5 26.602V7.078a2.789 2.789 0 0 1 2.789-2.789Z" />
