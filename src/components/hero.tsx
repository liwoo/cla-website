...
function HeroComponent() {
  return (
    <Container>
      <div className="card my-8 image-full">
        ...
        <div className="card-body flex-col justify-between  px-8 py-12">
          ...
          <div className="card-actions flex">
            <button className="btn bg-primary-content text-black">Watch Sermon</button>
