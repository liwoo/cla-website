...
const splitParagraphs = (str: string) => {
    ...
    <Container className="mt-20 text-white bg-secondary">
      ...
      <footer className="p-8 text-white footer bg-secondary">
        <div className="text-sm">
          {splitParagraphs(about).map(par => <p>{par}</p>)}
        </div>
        <div>
